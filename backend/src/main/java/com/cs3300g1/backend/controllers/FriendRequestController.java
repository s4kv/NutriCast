...
public class FriendRequestController {
    ...
    public FriendRequestController(FirebaseAuthService firebaseAuthService,
    ...
    public ResponseEntity<?> sendRequest(@RequestHeader("Authorization") String authHeader,
        ...
        System.out.println("Decoded Firebase UID: " + decoded.getUid());//----------------THIS WAS GOOD!!!!!!!!!!!!
        User sender = userService.findByAuthUid(decoded.getUid())
    ...
    public ResponseEntity<?> getIncomingRequests(@RequestHeader("Authorization") String authHeader) {
        ...
        User user = userService.findByAuthUid(decoded.getUid())
