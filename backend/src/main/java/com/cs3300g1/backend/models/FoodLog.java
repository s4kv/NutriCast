...
/**
 * This class represents a food that has been logged by a user. This class will include a unique id,
 * user id which represents the user that logged the food, food id which represents the food that
 * the user logged, number of servings, and the time when the user logged the food.
 */
@Document("food_logs")
@Getter
@Setter
...
public class FoodLog {
  @Id @ToString.Exclude private String id; // Unique id to identify the food log
