...
public class FoodService {
    ...
    public void saveFood(String userEmail, FoodRequest foodRequest) {
        ...
        Food food = new Food(null, user.getId(), foodRequest.getName(), foodRequest.getType(), foodRequest.getServingSize(), foodRequest.getServingUnit(), foodRequest.getFoodMacros());
