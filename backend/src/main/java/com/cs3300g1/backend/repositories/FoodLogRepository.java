...
/**
 * This interface represents the repository for the collection of foods_log in MongoDB. This
 * repository will be used to perform CRUD operations (Create, Read, Update, Delete) operations on
 * the foods collection.
 */
@Repository
public interface FoodLogRepository extends MongoRepository<FoodLog, String> {
  ...
  /**
   * Finds a list of foods logged that matches the user id and is in between two timestamps in the
   * database. For example, this will be used to find the number of calories consumed by a user in a
   * certain day.
   *
